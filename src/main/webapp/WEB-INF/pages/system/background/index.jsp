...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${whContextPath}/upload/${sessionScope.user.userHeadPortrait}" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;"
                       data-url="${whContextPath}/resources/page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2019 wh</span></p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.config({
        base: "${whContextPath}/resources/js/"
    }).extend({
        "bodyTab": "bodyTab"
    });
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            <%--url: "${pageContext.request.contextPath}/menu/loadIndexLeftMenuJson" //获取菜单json地址--%>
        });
