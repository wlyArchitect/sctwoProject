...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
        ...
        tableIns=table.render({
            ...
            ,page: true  //是否启用分页
            ,cols: [[   //列表数据
                 {field:'checkid', title:'序号',align:'center',width:'280'}
                ,{field:'checkdate', title:'开始时间',align:'center',width:'180'}
                ,{field:'problem', title:'结束时间',align:'center',width:'180'}
                ,{field:'opername', title:'考试总时间',align:'center',width:'120'}
                ,{field:'createtime', title:'考试总分',align:'center',width:'180'}
